...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--dataset-path",
        type=str,
        default="/home/xsling/Code/moe_profiler/data/ShareGPT_V3_unfiltered_cleaned_split.json",
    )
    parser.add_argument("--model", type=str, default="/data/Qwen2-57B-A14B-Instruct")
    ...
    parser.add_argument(
        "--block-size", type=int, default=16, help="block size of key/value cache"
    )
    parser.add_argument(
